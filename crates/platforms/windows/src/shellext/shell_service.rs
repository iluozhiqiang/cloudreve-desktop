...
pub fn init_and_start_service_task(host: Arc<dyn ShellExtensionHost>) -> ServiceHandle {
    let (tx, rx) = mpsc::channel();

    let mut services = ShellServices::new(host);
...
impl ShellServices {
    ...
    pub fn init_and_start_thumbnail_provider_handler(&mut self) -> Result<()> {
        ...
        unsafe {
            let factory: IClassFactory =
                ThumbnailProviderFactory::new(self.host.clone()).into();
    ...
    pub fn init_and_start_toast_handler(&mut self) -> Result<()> {
        ...
        unsafe {
            ...
            let factory: IClassFactory =
                ToastActivatorFactory::new(self.host.clone()).into();
    ...
    pub fn init_and_start_status_ui_handler(&mut self) -> Result<()> {
        ...
        unsafe {
            let factory: IClassFactory =
                StatusUIHandlerFactoryFactory::new(self.host.clone()).into();
    ...
    pub fn init_and_start_custom_state_handler(&mut self) -> Result<()> {
        ...
        unsafe {
            let factory: IClassFactory =
                CustomStateHandlerFactory::new(self.host.clone()).into();
    ...
    pub fn init_and_start_view_online_handler(&mut self) -> Result<()> {
        ...
        unsafe {
            // Create and register the class factory
            let factory: IClassFactory =
                CrExplorerCommandFactory::new(self.host.clone()).into();
